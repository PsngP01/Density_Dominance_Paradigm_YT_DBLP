...
# ==========================================
# Set BASE_DIR to the current working directory or a local 'data' folder
import os
...
EXCEL_OUTPUT = os.path.join(BASE_DIR, "Influencer_Data_Results_Master_Final.xlsx")
MATRIX_PNG = os.path.join(BASE_DIR, "Influencer_Matrix_Final.png")
MATRIX_HTML = os.path.join(BASE_DIR, "Interactive_Influencer_Matrix_Final.html")
SCREE_PNG = os.path.join(BASE_DIR, "PCA_Scree_Plot_Final.png")
IC_PNG = os.path.join(BASE_DIR, "IC_Simulation_Final.png")
IC_HTML = os.path.join(BASE_DIR, "Interactive_IC_Final.html")
STATS_OUTPUT = os.path.join(BASE_DIR, "Statistical_Validation.xlsx")
...
print(" Publication Pipeline Executing...")
...
graph_target = find_file("com-youtube.ungraph.txt")
community_target = find_file("com-youtube.all.cmty.txt")

print("\n Loading YouTube topology...")
